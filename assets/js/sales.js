...
$(function() {
	...
	$('#add_item').click(function(e) {
		...
		var fila = '<tr class="fila'+INDEX_ROW+'">'+
	                        '<td></td>'+
	                        '<td width="30%"><input type="text" style="display:none" id="articulo'+INDEX_ROW+'" name="articulo[]" class="form-control show_input'+INDEX_ROW+'" value="'+(articulo!=''?articulo:'Default')+'"><span id="articulo_s'+INDEX_ROW+'" class="hide_span'+INDEX_ROW+'">'+(articulo!=''?articulo:'Default')+'</span></td>'+
